    ...
    <form action="/update/{{  $book->id }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="" name="description" value="{{ $book->description }}">
            @error('description')
                <div style="color: red">{{ $message }}</div>
            @enderror
          </div>
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="" name="genre" value="{{ $book->genre }}">
            @error('genre')
                <div style="color: red">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="" name="stock" value="{{ $book->stock }}">
            @error('stock')
                <div style="color: red">{{ $message }}</div>
            @enderror
          </div>
          <div class="mb-3">
            ...
            <img src="{{ asset('storage/book_images/'. $book->photo) }}" class="card-img-top" style="width: 50px">
            @error('photo')
                <div style="color: red">{{ $message }}</div>
            @enderror
          </div>
